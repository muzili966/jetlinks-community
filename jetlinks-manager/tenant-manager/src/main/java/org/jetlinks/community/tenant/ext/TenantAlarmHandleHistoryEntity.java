...
/**
 * AlarmHandleHistoryEntity 的租户扩展: 通过实体工厂映射替换原实体, 零侵入添加租户列.
 *
 * @see org.jetlinks.community.tenant.config.TenantEntityMappingCustomizer
 */
@Getter
@Setter
public class TenantAlarmHandleHistoryEntity extends AlarmHandleHistoryEntity implements TenantAware {
